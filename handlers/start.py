...
WELCOME_TEXT = (
    ...
    "Сначала задайте вопрос AI. Если ответ не поможет, бот предложит создать "
    "тикет оператору.\n"
    "Алдымен AI-ға сұрақ қойыңыз. Жауап көмектеспесе, бот операторға тикет "
    "ашуды ұсынады."
)
...
FAQ_TEXT = (
    ...
    "FAQ кейін қосылады.\n\n"
    "Пока можно задать текстовый вопрос AI. После ответа AI можно создать "
    "тикет оператору.\n"
    "Әзірге AI-ға мәтіндік сұрақ қоюға болады. AI жауабынан кейін операторға "
    "тикет ашуға болады."
)
